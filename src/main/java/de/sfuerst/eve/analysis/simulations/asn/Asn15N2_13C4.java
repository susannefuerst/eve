...
public class Asn15N2_13C4 {
    
    public static final MyLogger LOGGER = MyLogger.getLogger(Asn15N2_13C4.class);
	...
	MSLineChartApplicationWindow demo = new MSLineChartApplicationWindow("ASN-15N2-13C4", "ASN-15N2-13C4", "", continuous, true);
	demo.pack();
